      ...
      <div className="p-3 border-t border-border/30 space-y-2">
        ...
        <div className="rounded-xl bg-muted/40 border border-border/30 p-3 space-y-2">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[hsl(var(--claw-red))] to-[hsl(var(--claw-coral))] flex items-center justify-center text-xs font-bold text-primary-foreground">
              A
            </div>
            <div>
              <p className="text-sm font-semibold text-foreground leading-tight">Akshat</p>
